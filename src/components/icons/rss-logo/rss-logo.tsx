...
import s from './rss-logo.module.scss';

interface IRssLogoProps {
  iconTitle?: string;
  styleClass?: string;
};

const RssLogo: React.FC<IRssLogoProps> = ({ iconTitle = '', styleClass = null }) => {
  return (
    <svg
    ...
    >
      <title id={iconTitle}>RS School JS</title>
      ...
      <ellipse transform="rotate(-37.001 420.46 67.88)" className={s.icon_ellipse} cx="420.5" cy="67.9" rx="63" ry="51.8"/>
